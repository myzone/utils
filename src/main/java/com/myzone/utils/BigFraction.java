...
public final class BigFraction extends Number implements Comparable<Number> {
     ...
     */
    @NotNull
    public static BigFraction valueOf(@NotNull Number n) {
        if (n instanceof BigFraction)
            return (BigFraction) n;
        else if (isInt(n))
            return new BigFraction(toBigInteger(n), BigInteger.ONE, true);
     ...
     */
    @NotNull
    public static BigFraction valueOf(@NotNull String s) {
     ...
     */
    @NotNull
    private static BigInteger toBigInteger(@NotNull Number n) {
     ...
     */
    @NotNull
    public BigFraction subtract(@NotNull Number n) {
        if (n == null)
     ...
     */
    @NotNull
    public BigFraction multiply(@NotNull Number n) {
        BigFraction f = valueOf(n);
     ...
     */
    @NotNull
    public BigFraction divide(@NotNull Number n) {
        BigFraction f = valueOf(n);
     ...
     *
     * @throws ArithmeticException if this == 0 && exponent < 0.
     */
    @NotNull
     ...
     */
    public int compareTo(@NotNull BigFraction f) {
     ...
     */
    @NotNull
    public BigFraction min(@NotNull BigFraction f) {
     ...
     */
    @NotNull
    public Number min(@NotNull Number n) {
     ...
     */
    @NotNull
    public BigFraction max(@NotNull BigFraction f) {
        return this.compareTo(f) >= 0 ? this : f;
    }
     ...
     */
    @NotNull
    public Number max(@NotNull Number n) {
        return this.compareTo(n) >= 0 ? this : n;
    }
